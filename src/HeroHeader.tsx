...
export function HeroHeader({ onDemo }: { onDemo: () => void }) {
  return <nav className="landing-nav" aria-label="Main navigation">
    <a className="landing-brand" href="?hero=1" aria-label="DeltaNet home"><img src={assetUrl('/logo-options/split-delta.svg')} width="29" height="24" alt="" /><span>DeltaNet</span></a>
