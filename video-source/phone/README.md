...
Framing: the full device has 46 px of top/bottom breathing room. Header and conversation close-ups keep the upper bezel at least 60 px inside the 1304 px frame; composer and task-sheet close-ups intentionally follow the lower half. Camera poses are shared by all three tours.
